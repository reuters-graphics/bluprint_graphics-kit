...
The graphics design system is a [Tailwind](https://tailwindcss.com/docs/)-inspired, token-based style system you can use to design graphics pages and embeds.

<LinkCard
  title="Reuters graphics styles"
  description="Read more about the graphics design system in the Reuters graphics components docs."
