...
- `sharecard.ait`: Template for making images at the ideal size for teasers on social media and in search results

Create a new `.ai` file for each new graphic you want to create in the root of the `project-files/` directory. The name of the file should be a valid slug (lowercase letters, hyphens instead of spaces).

<FileTree>
  - project-files - ai2html.ait - **bar-chart.ai** - **locator-map.ai**
</FileTree>
...
2. A svelte component and images will be exported within the graphics kit.
   <FileTree> - project-files - **map.ai** Illustrator file - src - lib - ai2svelte - **map.svelte** Exported Svelte component - statics - images - graphics - **map-xs.jpg** Exported graphic images - **map-sm.jpg** - **map-md.jpg** - ...
   </FileTree>
   </Steps>
...
2. Create an AI graphic from the `.ait` template in `project-files/` with a sluggable name (i.e., lowercase letters, hyphens instead of spaces).
   <FileTree>
     - project-files - ai2html.ait Template - **map.ai** New graphic
   </FileTree>
3. Export the graphic using [ai2svelte](#ai2svelte).
   <FileTree>
     - project-files - ai2html.ait - map.ai - src - lib - ai2svelte -
     **map.svelte**
   </FileTree>
4. Make an embeddable graphic page using the ["Make ai2svelte embeds"](/bluprint_graphics-kit/developers/mods/#make-ai2svelte-embeds) kit mod.
   <FileTree>
     - pages - embeds - en - map - **+page.svelte** - project-files -
     ai2html.ait - map.ai - src - lib - ai2svelte - map.svelte
   </FileTree>
...
6. Before publishing, run ["Export AI statics"](/bluprint_graphics-kit/developers/mods/#export-ai-statics) kit mod to create JPG and EPS media assets and Sphinx preview image for your graphic.
   <FileTree> - media-assets - en - map - **graphic.jpg** - **graphic.eps** - project-files - ai2html.ait - map.ai - src - statics - images - embeds - en - **map.jpg**
   </FileTree>
   </Steps>
...
<FileTree>
  - project-files - layers - **satellite.jpg** Linked image - map.ai AI file
  using linked image
</FileTree>
...
<FileTree>- project-files - ai2html.ait - **locator-map.ai** >100 MB</FileTree>
...
You should **re-rasterise hi-res images** to a lower resolution, which will significantly reduce your `.ai` filesize. A good rule of thumb is to try a medium resolution like `150ppi`, which will still preserve details for print.
