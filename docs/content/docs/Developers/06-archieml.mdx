...
[ArchieML](https://archieml.org/) is a document syntax developed at the New York Times to quickly create structured data for web pages and graphics. It is also designed to be "a format that could survive being edited by users who may never have seen ArchieML or any other markup language at all before."

You can read more about [ArchieML syntax basics on its website](https://archieml.org/#demo).

ArchieML documents are saved as JSON files in your project.
...
<LinkCard
  ...
  description="Read more about RNGS.io commands and config in the developer docs for the rngs-io-client library"
