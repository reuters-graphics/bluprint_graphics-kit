...
So to use media files in your component code, you need to prefix the path to them using SvelteKit's [built-in `asset` store](https://svelte.dev/docs/kit/$app-paths#asset). Here's how:
