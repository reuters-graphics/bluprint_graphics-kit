...
The locales directory contains JSON files with text values for pages and graphics, usually from [ArchieML docs](/bluprint_graphics-kit/developers/archieml/).
...
The graphics kit can be used to publish any of the three types of projects we make: dotcom **pages-only**, **embeds-only** or dotcom pages and embeds (**pages+**).
