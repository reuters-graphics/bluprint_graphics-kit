...
<FileTree>
  - locales - ... Text content from ArchieML docs - media-assets - ... Statics
  for media clients - pages - ... Publishable pages and embeds - project-files -
  ... Adobe Illustrator files - src - ... Editable components and code
</FileTree>

### `locales/`

<FileTree>- locales - en - content.json</FileTree>
...
<FileTree>- media-assets - en - chart - chart.jpg - chart.eps</FileTree>
...
<FileTree>
  - pages - embed-previewer - +page.svelte A page to preview embeds - embeds -
  en - page - +page.svelte Embeddable version of project homepage - map -
  +page.svelte Embeddable graphic - +layout.ts - +page.svelte Project homepage
</FileTree>
...
<FileTree>
  - project-files - ai2html.ait Template for graphics - dotcom.ait Template for
  dotcom homepage images - sharecard.ait Template for social share images
</FileTree>
...
<FileTree>
  - src - lib - components Project components - ... - styles Stylesheets -
  global.scss - App.svelte - statics Static assets - images -
...
<Aside type="caution">
  You should _rarely_ publish dotcom-only projects. In most cases, you should
  _at least_ publish an embeddable version of your project's dotcom homepage,
  which comes preconfigured when you start a project.
</Aside>
