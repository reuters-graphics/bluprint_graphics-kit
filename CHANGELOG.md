...
- 6e3b0bf: Update `@reuters-graphics/graphics-components` from 4.10.1 to [4.12.0](https://github.com/reuters-graphics/graphics-components/releases/tag/v4.12.0).

## 2.11.8

### Patch Changes

- 5c1e4f8: Update `@reuters-graphics/graphics-components` from 4.8.0 to [4.8.1](https://github.com/reuters-graphics/graphics-components/releases/tag/v4.8.1).
- c131e22: Update internal dependencies:

  - `@reuters-graphics/graphics-components` from 4.8.1 to [4.10.1](https://github.com/reuters-graphics/graphics-components/releases/tag/v4.10.1)
  - `@reuters-graphics/graphics-kit-publisher` from 3.5.0 to [3.5.1](https://github.com/reuters-graphics/graphics-kit-publisher/releases/tag/v3.5.1)

## 2.11.7

### Patch Changes

- 93e2558: Update `@reuters-graphics/graphics-components` from 4.7.0 to [4.8.0](https://github.com/reuters-graphics/graphics-components/releases/tag/v4.8.0).
...
- 339e74c: Fix the Docs GitHub Actions workflow, which was failing on every run since the `savile` 0.2.0 update. The repo had drifted to three different resolved `sharp` versions; the root-level pin (`^0.33.5`) was older than what `astro` itself now requires (`^0.34.0`), and that stale copy was falling back to a broken legacy native-binary build. Bumping the root `sharp` dependency to `^0.34.5` collapses the duplicate installs and lets Astro's image optimization use a working prebuilt binary.
...
- c7a34f3: Redesign the `bin/mods/` module for maintainability and safety.
...
- 9604967: Update GitHub Actions workflow dependencies and bump the minimum Node version to 22 (testing on 22 and 24).
...
- 535a314: Updates @reuters-graphics dependencies to latest versions.

## 2.2.16

### Patch Changes

- 5f6fe5b: Updates @reuters-graphics dependencies to latest versions.
...
- 9669e4a: Updates @reuters-graphics dependencies to latest versions.

## 2.2.13

### Patch Changes

- 9a7e333: Updates @reuters-graphics dependencies to latest versions.
...
- 3e42b03: Updates @reuters-graphics dependencies to latest versions.

## 2.2.10

### Patch Changes

- 531fe2c: Updates @reuters-graphics dependencies to latest versions.
