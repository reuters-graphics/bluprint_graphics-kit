...
Check out Svelte's [official migration guide](https://svelte.dev/docs/svelte/v5-migration-guide) to read up on Svelte 5's overhauled syntax and new reactivity system.
